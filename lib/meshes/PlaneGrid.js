...
export default function PlaneGrid( props ){
    props = Object.assign( { mat:null, size:1, segments:1  }, props );

    const geo = new THREE.PlaneGeometry( props.size, props.size, props.segments, props.segments );
