...
class DynLineMesh extends THREE.LineSegments{
    ...
    obb( c, x, y, z, col=this._defaultColor, is_dash=false ){
        ...
        this.add( ba, bb, col, null, is_dash ); // Back
        this.add( bb, bc, col, null, is_dash );
        this.add( bc, bd, col, null, is_dash );
        this.add( bd, ba, col, null, is_dash );
        this.add( fa, fb, col, null, is_dash ); // Front
        this.add( fb, fc, col, null, is_dash );
        this.add( fc, fd, col, null, is_dash );
        this.add( fd, fa, col, null, is_dash );
        this.add( fa, ba, col, null, is_dash ); // Connect
        this.add( fb, bb, col, null, is_dash );
        this.add( fc, bc, col, null, is_dash );
        this.add( fd, bd, col, null, is_dash );
        return this
    }
