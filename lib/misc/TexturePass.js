...
export default class TexturePass{
    constructor( mat, w=256, h=256 ){
        ...
        // this.fbo.texture.wrapS =  THREE.RepeatWrapping;
        // this.fbo.texture.wrapT =  THREE.RepeatWrapping;
        
        // this.fbo.texture.magFilter = THREE.NearestFilter;
        // this.fbo.texture.minFilter = THREE.LinearMipmapLinearFilter; //THREE.NearestFilter;
    }
    ...
    useMipmaps(){
        // Use MSAA when rendering
        this.fbo.samples = 4;

        // Turn on feature & set filters that work well with it
        this.fbo.texture.generateMipmaps = true;    
        this.fbo.texture.magFilter       = THREE.NearestFilter;
        this.fbo.texture.minFilter       = THREE.LinearMipmapLinearFilter;
        return this
    }
